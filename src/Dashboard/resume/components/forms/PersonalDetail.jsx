         ...
         <form onSubmit={onSave}>
           <div className='grid grid-cols-2 mt-5 gap-2'>
             ...
             <div className='col-span-2'>
               <label className='text-sm' htmlFor="">Job Title <span className='text-red-600'>*</span></label>
               <Input name="jobTitle" defaultValue={resumeInfo?.jobTitle} required onChange={handelInputChange} />
             </div>
             <div className='col-span-2'>
               <label className='text-sm' htmlFor="">Address <span className='text-red-600'>*</span></label>
               <Input name="address" defaultValue={resumeInfo?.address} required onChange={handelInputChange} />
             </div>
             <div>
               <label className='text-sm' htmlFor="">Contact <span className='text-red-600'>*</span> </label>
               <Input name="contact" defaultValue={resumeInfo?.contact} required onChange={handelInputChange} />
             </div>
             <div>
             ...
             <div>
               <label className='text-sm' htmlFor="">LinkedIn</label>
               <Input name="linkedin" defaultValue={resumeInfo?.linkedin}  onChange={handelInputChange} />
             </div>
